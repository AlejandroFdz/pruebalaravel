...
<head>
    ...
    <!-- Checkbox styles for registration page -->
    @yield('checkbox_styles')
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        @if (Auth::user() && Auth::user()->admin == 1)
                            <li {{{ (Request::is('admin') ? 'class=current-item' : '') }}}>
                        ...
                        <li {{{ (Request::is('tickets') ? 'class=current-item' : '') }}}>
                        ...
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="{{ route('user.profile') }}">Mi Cuenta</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('logout') }}"
