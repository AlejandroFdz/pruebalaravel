    ...
    @if( isset($content['column_1']) && isset($content['column_2']) )
        <div>
            ...
            ">
                ...
                @if( $content['column_1']['link']['url'] == '#' || $content['column_1']['link']['url'] == '' || $content['column_1']['link']['url'] == ' ' )
                    <a href="#" id="two_posts_left_link" target="_blank" style="
            ...
            ">
                ...
                @if( $content['column_2']['link']['url'] == '#' || $content['column_2']['link']['url'] == '' || $content['column_2']['link']['url'] == ' ' )
                    <a href="#" id="two_posts_left_link" target="_blank" style="
                    color:{{$content['column_2']['link']['color']}};">
                @else
                    <a href="{{$content['column_2']['link']['url']}}" id="two_posts_left_link" target="_blank" style="
                    color:{{$content['column_2']['link']['color']}};">
                @endif
