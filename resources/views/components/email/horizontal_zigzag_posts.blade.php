        ...
        <div style="display: inline-block;">
            ...
            <div style="width:52%;float:right;">
                ...
                <strong style="font-size:18px;">
                    @if( $content['row_1']['link'] == '#' || $content['row_1']['link'] == '' || $content['row_1']['link'] == ' ' )
                        <a href="#" id="row_1_link">Leer más...</a>
                    @else
                        <a href="{{{config('app.url')}}}/email/clicked/{{{$campaign_data['list_id']}}}/{{{$campaign_data['subscriber_id']}}}/{{{$campaign_data['emails_sended']}}}/{{$content['row_1']['link']}}" id="row_1_link">Leer más...</a>
                    @endif                    
                </strong>
            </div>
        </div>
    ...
    @if( isset($content['row_2']) )
        <div style="display: inline-block;margin-top:15px;margin-bottom:15px;">
            ...
            <div style="width:52%;float:right;">
                ...
                <strong style="font-size:18px;">
                    @if( $content['row_2']['link'] == '#' || $content['row_2']['link'] == '' || $content['row_2']['link'] == ' ' )
                        <a href="#" id="row_2_link">Leer más...</a>
                    @else
                        <a href="{{{config('app.url')}}}/email/clicked/{{{$campaign_data['list_id']}}}/{{{$campaign_data['subscriber_id']}}}/{{{$campaign_data['emails_sended']}}}/{{$content['row_2']['link']}}" id="row_2_link">Leer más...</a>
                    @endif
                </strong>
            </div>
        </div>
    ...
    @if( isset($content['row_3']) )
        <div style="display: inline-block;">
            ...
            <div style="width:52%;float:right;">
                ...
                <strong style="font-size:18px;">
                    @if( $content['row_3']['link'] == '#' || $content['row_3']['link'] == '' || $content['row_3']['link'] == ' ' )
                        <a href="#" id="row_3_link">Leer más...</a>
                    @else
                        <a href="{{{config('app.url')}}}/email/clicked/{{{$campaign_data['list_id']}}}/{{{$campaign_data['subscriber_id']}}}/{{{$campaign_data['emails_sended']}}}/{{$content['row_3']['link']}}" id="row_1_link">Leer más...</a>
                    @endif
                </strong>
            </div>
        </div>
