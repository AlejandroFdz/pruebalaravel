...
<div id="admin_{{$component->name}}" class="mod-settings" style="display:none;">
    ...
    @if( isset($content['row_1']) )
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="admin_zigzag_row1_link" name="admin_row1_link" value="{{$content['row_1']['link']}}" placeholder="Elige un enlace">
        </div>
    @endif
    ...
    @if( isset($content['row_1']) )
        ...
        <div class="form-group">
            <label for="title">Enlace</label>
            <input type="text" class="form-control" id="admin_zigzag_row2_link" name="admin_row2_link" value="{{$content['row_2']['link']}}" placeholder="Elige un enlace">
        </div>
    @endif
    ...
    @if( isset($content['row_3']) )
        ...
        <div class="form-group">
            <label for="title">Enlace</label>
            <input type="text" class="form-control" id="admin_zigzag_row3_link" name="admin_row3_link" value="{{$content['row_3']['link']}}" placeholder="Elige un enlace">
        </div>
    @endif
