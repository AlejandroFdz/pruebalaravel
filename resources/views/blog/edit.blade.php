            ...
            <div class="col-md-8">
                ...
                <ul class="mainmenu">
                  @if (Auth::user() && Auth::user()->admin == 1)
                      ...
                      <li>
                        <a href="url('/subscriptions')">Suscripciones</a>
                      </li>
                      <li>
          ...
          @if( $is_admin == 1 )
            ...
            <div id="addPostForm" class="row">
              ...
              <div class="col-md-6">
                ...
                {!! Form::open(['route' => array('blog.update', $post[0]->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal', 'role' => 'form', 'files' => true]) !!}
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div id="inputfilesjs" class="input-group">
                        ...
                        <input class="input_filename form-control" name="picture_filename" readonly="" type="text" value="{{$post[0]->featured_picture}}">
                      </div>
                    </div>

                    <div class="form-group">
                      {{Form::label('title', 'Título')}}
                      {{Form::text('title', $post[0]->title, array('class' => 'form-control', 'placeholder'=>'Título', 'required' => 'required'))}}
                    </div>

                    <div class="form-group">
                      {{Form::label('body', 'Contenido')}}
                      {{Form::textarea('body', $post[0]->content, array('class' => 'form-control', 'placeholder'=>'Contenido', 'id' => 'summernote', 'required' => 'required'))}}
                    </div>

                    {!! Form::token() !!}
                    
                    <div class="form-group">
                      {!! Form::submit('Modificar', ['class' => 'btn btn-primary pull-right', 'style' => 'margin-top:10px;']) !!}
                    </div>
